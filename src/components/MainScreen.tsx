...
function MainScreen({ config, setAppProcessing, onNavigateToCredits, onCreditsUpdate, onProcessingStateChange, onEstimatedCostChange }: MainScreenProps) {
  const {
    isAuthenticated,
    credits,
  ...
  // Model names may differ between apis endpoint and ServicesInfo
  // e.g. "gemini25-pro" vs "gemini2.5-pro" — normalize by stripping dots and dashes
